...
const Personas = () => {
    ...
    const cards = [
        {
            ...
            activeColor: 'bg-black/80', // Fallback
        ...
        },
        {
            ...
            activeColor: 'bg-[#366B86]/85', // Blueish teal with opacity
        ...
        },
        {
            ...
            activeColor: 'bg-[#1E5F34]/85', // Deep Green with opacity
        ...
        },
        {
            ...
            activeColor: 'bg-[#8B0000]/85', // Deep Red with opacity
    ...
    // Hybrid State: Students CLOSED (false), others OPEN (true) by default.
                    ...
                    {cards.map((card) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={`absolute inset-0 bg-black/20 transition-opacity duration-300 ${isOpen ? 'opacity-0' : 'opacity-100'}`} />
